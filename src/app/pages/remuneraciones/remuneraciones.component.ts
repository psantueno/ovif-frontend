...
export class RemuneracionesComponent implements OnInit, OnDestroy {
  ...
  get borradoContexto(): BorradoContexto | null {
    ...
    return construirContextoBorrado(
      ...
      'remuneraciones',
      this.esRectificacion ? 'rectificacion' : 'regular'
    );
  }
  ...
  onConfirmarBorrado(): void {
    ...
    confirmarBorrado(this.borradoContexto).then((result) => {
      ...
      this.municipioService
        .borrarDatosModulo({ municipioId, ejercicio, mes, modulo: 'remuneraciones', tipoCarga: this.esRectificacion ? 'rectificacion' : undefined })
