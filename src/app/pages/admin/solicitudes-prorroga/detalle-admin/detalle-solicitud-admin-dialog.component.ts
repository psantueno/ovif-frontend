...
@Component({
  selector: 'app-detalle-solicitud-admin-dialog',
  standalone: true,
  imports: [
    CommonModule,
    MatDialogModule,
  ...
  templateUrl: 'detalle-solicitud-admin-dialog.component.html',
  styleUrl: 'detalle-solicitud-admin-dialog.component.scss'
})
export class DetalleSolicitudAdminDialogComponent {
